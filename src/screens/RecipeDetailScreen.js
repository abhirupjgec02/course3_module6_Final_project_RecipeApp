      ...
      {/* recipe Description */}
        <View style={styles.contentContainer}>
          ...
          <View style={styles.miscContainer} testID="miscContainer">
            ...
            <View style={styles.miscItem}>
              <Text style={styles.miscIcon}>👥</Text>
              <Text style={styles.miscText}>02 Servings</Text>
            </View>
            <View style={styles.miscItem}>
              <Text style={styles.miscIcon}>🔥</Text>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={styles.ingredientsList} testID="ingredientsLis">
              {(recipe.ingredients).map((ingred) => (
                <View key={ingred.ingredientName} style={styles.ingredientItem}>
                  <View style={styles.ingredientBullet} />
                  <Text style={styles.ingredientText}>
                    {/* {meal["strMeasure" + ingred]} {meal["strIngredient" + ingred]} */}
                    {ingred.ingredientName} {ingred.measure}
                  </Text>
                </View>
              ))}
            </View>
